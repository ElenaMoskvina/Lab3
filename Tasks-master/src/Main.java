...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i = 0;i<6;i++){
            ArrData[i] = DataReader.StringDouble(DataReader.FileLineReader("Data"),i)[0];
        }

        ArrayList<Double> ArrDataProgWr  = DataReader.ListDouble(DataReader.FileLineReader("Data"),7);
        ArrayList<Double> ArrDataProgEx = DataReader.ListDouble(DataReader.FileLineReader("Data"), 8);
        double lenghtNewProg = DataReader.StringDouble(DataReader.FileLineReader("Data"),9)[0];
